...
func (s *FunctionStore) Get(fname string) (*models.Function, error) {
...
func (s *FunctionStore) GetAll() ([]*models.Function, error) {
...
func (s *FunctionStore) Delete(f models.Function) error {
